...
class ShowSentenceFrame(ctk.CTkFrame):
  def __init__(self,master, **kwargs):
    ...
    self.sentence = ctk.CTkTextbox(self,wrap="word",font=("meiryo",15,"bold"),fg_color="#333333",text_color="black",state="disabled",padx=13,pady=5)
    self.sentence.grid(row=0, column=0, padx=0, pady=0,sticky="news")

  def set_sentence_config(self):
  ...
  def resizeText(self):
    height = self.sentence.winfo_height()
